...
public:
        ...
        bool show_progress = false)
    {
        ...
        if (sub_mbytes*2 > buf_megabytes) {
            throw InsufficientMemoryException(
                "Please provide more memory. At least " + std::to_string(sub_mbytes*2));
        }
        ...
        std::cout << std::endl<< std::endl << std::endl <<"Plotter Plus Version :1.0.0 (By Moden)" << std::endl;
        std::cout << "Github:https://github.com/ModenCn/chia_plotter_plus" << std::endl;
        std::cout << "QQ Group: 30335811" << std::endl << std::endl << std::endl;
        {
            // Scope for FileDisk
